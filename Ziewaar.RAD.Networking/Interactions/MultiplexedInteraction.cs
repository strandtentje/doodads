...
public class MultiplexedInteraction(IInteraction repeater, ProtocolOverStream interactionProtocol, Stream asStream)
    : IInteraction, ISourcingInteraction, ISinkingInteraction
{
    ...
    public IReadOnlyDictionary<string, object> Memory { get; } =
        new FallbackReadOnlyDictionary(new SideChannelDictionary(interactionProtocol), repeater.Memory);
